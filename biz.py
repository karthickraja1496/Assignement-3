...
sql_connect = mysql.connect(host='localhost', user='root', password='')
cur = sql_connect.cursor()
cur.execute("CREATE DATABASE IF NOT EXISTS business")
sql_connect.commit()
cur.close()
sql_connect.close()
...
icon = Image.open("D:/Documents/bizcard/download.png")
st.set_page_config(page_title= "BizCardX: Extracting Business Card Data with OCR |",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This OCR app is created by *Karthickraja*!"""})
...
sql_connect = mysql.connect(host='localhost', user='root', password='', database="business")
cur = sql_connect.cursor()
...
if selected_option == "Home":
    ...
    with col2:
        st.image("download.png", caption="App Overview", use_column_width=True)
    st.markdown(
